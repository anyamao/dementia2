  ...
  return (
    <div className="w-full h-full bg-white flex flex-col items-center relative ">
      ...
      <div className="bg-gray-100 w-full p-[20px] pb-[50px] ">
        ...
        <p>
          Каждые три секунду в мире кому-то ставят диагноз 'деменция'. Сейчас с
          ней живут более 55 миллионов человек. До 45% этих случаев деменции
      ...
      <div className="w-full bg-emerald-200  p-[20px]">
